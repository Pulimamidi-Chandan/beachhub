...
import { MapPin, Waves, Sun, Wind, ThermometerSun, ArrowLeft, Star } from "lucide-react";
...
const BeachDetails: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchBeach = async () => {
      try {
        const response = await fetch(`http://localhost:5000/api/beaches/beach/${id}`);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="relative h-80">
          <img src={beach.imageUrl || "/default-beach.jpg"} alt={beach.name} className="w-full h-full object-cover" />
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-blue-50 p-4 rounded-lg flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{beach.waterConditions || "Unknown"}</p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg flex items-center">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{beach.weather || "Varies"}</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <p className="text-gray-700">{beach.bestTimeToVisit || "Year-round"}</p>
            </div>
          </div>
        </div>
      </div>
